...
{   
   ...
   if (liter.EndOfList())
   {
      std::cerr << "GetVertex: the vertex is not in the graph."
           << std::endl;
      pos = -1;
   }
   return pos;
...
int Graph<T>::GetWeight(const T& vertex1, const T& vertex2)
{
   ...
   if (pos1 == -1 || pos2 == -1)
   {
      std::cerr << "GetWeight: a vertex is not in the graph."
           << std::endl;
      return -1;
   }
...
SeqList<T>& Graph<T>::GetNeighbors(const T& vertex)
{
   ...
   if (pos == -1)
   {
      std::cerr << "GetNeighbors: the vertex is not in the graph."
           << std::endl;
                          ...
                          const T& vertex2, int weight)
{
   ...
   if (pos1 == -1 || pos2 == -1)
   {
      std::cerr << "InsertEdge: a vertex is not in the graph."
           << std::endl;
      return;
   }
...
void Graph<T>::DeleteVertex(const T& vertex)
{
   ...
   if (pos == -1)
   {
      std::cerr << "DeleteVertex: a vertex is not in the graph."
           << std::endl;
      return;
   }
...
void Graph<T>::DeleteEdge(const T& vertex1, const T& vertex2)
{
   ...
   if (pos1 == -1 || pos2 == -1)
   {
      std::cerr << "DeleteEdge: a vertex is not in the graph."
           << std::endl;
      return;
   }
   edge[pos1][pos2] = 0;
