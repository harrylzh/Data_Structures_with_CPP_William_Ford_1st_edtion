...
int main(void)
{
    String s1((char *)"STRING "), s2((char *)"CLASS");
    String s3;
    int i;
    char c, cstr[30];
    ...
    cout << "The first occurrence of 'S' in " << s2 << " =  " << s2.Find('S', 0) << endl;
    cout << "The last occurrence of 'S' in " << s2 << " is " << s2.FindLast('S') << endl;
    cout << "Insert 'OBJECT ' into s3 at position 7." << endl;
    s3.Insert((char *)"OBJECT ", 7);
    cout << s3 << endl;
